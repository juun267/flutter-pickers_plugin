    ...
    return Expanded(
      child: Container(
        ...
        child: CupertinoPicker.builder(
          ...
          itemBuilder: (_, index) {
            final String text = '${_dateTimeData.getListByName(dateType)[index]}${widget.route.suffix?.getSingle(dateType)}';
            final int date = _dateTimeData.getListByName(dateType)[index];
            bool isSelect = false;
            switch (dateType) {
              case DateType.Year:
                isSelect = _selectData.year == date;
                break;
              case DateType.Month:
                isSelect = _selectData.month == date;
                break;
              case DateType.Day:
                isSelect = _selectData.day == date;
                break;
              case DateType.Hour:
                isSelect = _selectData.hour == date;
                break;
              case DateType.Minute:
                isSelect = _selectData.minute == date;
                break;
              case DateType.Second:
                isSelect = _selectData.second == date;
                break;
            }
            return Align(
                ...
                child: Text(text,
                    style: TextStyle(
                      color: isSelect ? _pickerStyle.selectColor : _pickerStyle.textColor,
